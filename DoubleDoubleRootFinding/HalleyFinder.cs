...
namespace DoubleDoubleRootFinding {
    public static class HalleyFinder {

        public static ddouble RootFind(
            Func<ddouble, (ddouble v, ddouble d1, ddouble d2)> f,
            ddouble x0,
        ...
        public static ddouble Delta(
            ...
            (ddouble v, ddouble d1, ddouble d2) = f(x);

            ddouble dx = ddouble.Ldexp(v * d1, 1) / (v * d2 - ddouble.Ldexp(d1 * d1, 1));
